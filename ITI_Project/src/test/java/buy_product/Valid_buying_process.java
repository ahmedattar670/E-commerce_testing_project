...
public class Valid_buying_process {
	...
	public void testImplicitTest() throws InterruptedException {
	    ...
	    finishBtn.click();
	    Thread.sleep(2000);
	    WebElement txtfinish = driver.findElement(By.cssSelector("h2.complete-header"));
	    Assert.assertEquals("THANK YOU FOR YOUR ORDER", txtfinish.getText());
	    Thread.sleep(2000);
